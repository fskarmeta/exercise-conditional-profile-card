...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class=${variables.socialMediaPosition}>
            <li target="_blank"><a href="https://twitter.com/${variables.twitter}"><i class="fa fa-twitter"></i></a></li>
            <li target="_blank"><a href="https://github.com/${variables.github}"><i class="fa fa-github"></i></a></li>
            <li target="_blank"><a href="https://linkedin.com/in/${variables.linkedin}"><i class="fa fa-linkedin"></i></a></li>
            <li target="_blank"><a href="https://instagram.com/${variables.instagram}"><i class="fa fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
